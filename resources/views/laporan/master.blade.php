...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('') }}images/sleman.png">
    <table class="table table-borderless table-condensed table-hover" width="100%">
        <tr>
            <td width="13%" align="center"><img src="{{ asset('') }}images/sleman.png"></td>
            <td width="74%" align="center">
                <p class="kecil">
                    <font size="5" face="times new roman"><b>SMK MUHAMMADIYAH MLATI, SLEMAN<br><br></b></font>
                    <font size="4" face="times new roman">
                        NPSN. 20401319<br><br>
                        Jl. Kaliurang Jl. Timor Tim. No.KM 6,5, Purwosari, Sinduadi, Kec. Mlati<br><br> Kabupaten
                        Sleman, Daerah Istimewa Yogyakarta 55284
                    </font>
                </p>
            </td>
            <td width="13%" align="center"><img src="{{ asset('') }}images/Logo.png"></td>
        </tr>
    </table>
